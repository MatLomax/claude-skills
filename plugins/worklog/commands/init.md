---
description: Initialize worklog for this project (idempotent — creates .worklog/tasks.db)
---

Run `worklog init` in the project root using the Bash tool.

This creates `.worklog/tasks.db` for the current project if it does not already
